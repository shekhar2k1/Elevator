...
if __name__ == "__main__":
    ...
    count = len(arguments)
    if len(arguments) ==  3:
        print("usage pythonfile.py <num_elev> <num_floor> <max_capacity_per_elev>")
        num_elev = sys.argv[1]
        num_floors = sys.argv[2]
        max_capacity = sys.argv[3]
    else:
        print("usage pythonfile.py <num_elev> <num_floor> <max_capacity_per_elev>")
        print("Defaulting to num_elv 2 num_floors 6 max_capacity_per_elev 2")
        num_elev = 3
        num_floors = 8
        max_capacity = 2
    ...
    while True:
        ...
        if len(data) == 1:
            ...
            e.elev_request(int(data[0]), int(data[1]))
