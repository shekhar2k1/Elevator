I am attaching two files. Both have same code but first one auto generates the requests and always steps after a request. In the end it steps until it finishes all the requests (20 default).
